...
RUN apt update -y && apt upgrade -y && apt install -y build-essential apt-utils python3 python3-pip scons cmake libpng-dev libjpeg-dev libilmbase-dev libxerces-c-dev libglewmx-dev libxxf86vm-dev libpcrecpp0v5 libeigen3-dev libfftw3-dev libglu1-mesa-dev freeglut3-dev mesa-common-dev git vim curl qt5-default libqt5xmlpatterns5-dev \
