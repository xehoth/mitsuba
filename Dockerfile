...
RUN apt update -y && apt upgrade -y && apt install -y build-essential pkg-config apt-utils python3 python3-pip scons cmake libglewmx-dev libxxf86vm-dev libpcrecpp0v5 libglu1-mesa-dev freeglut3-dev mesa-common-dev git vim curl qt5-default libqt5xmlpatterns5-dev \
